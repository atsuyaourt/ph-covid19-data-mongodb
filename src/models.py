...
REGION_MAP = {
    ...
    "CAR": "Cordillera Administrative Region (CAR)",
    "REGION 1": "Ilocos Region (Region I)",
    "REGION 2": "Cagayan Valley (Region II)",
    "REGION 3": "Central Luzon (Region III)",
    "REGION 4-A": "CALABARZON (Region IV-A)",
    "REGION 4-B": "MIMAROPA (Region IV-B)",
    "REGION 5": "Bicol Region (Region V)",
    "REGION 6": "Western Visayas (Region VI)",
    "REGION 7": "Central Visayas (Region VII)",
    "REGION 8": "Eastern Visayas (Region VIII)",
    "REGION 9": "Zamboanga Peninsula (Region IX)",
    "REGION 10": "Northern Mindanao (Region X)",
    "REGION 11": "Davao Region (Region XI)",
    "REGION 12": "SOCCSKSARGEN (Region XII)",
    "CARAGA": "Caraga (Region XIII)",
